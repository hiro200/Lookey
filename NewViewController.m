...
//  Lookey
//
//  Created by nexbiz-korea on 2015. 12. 4..
...
#define CELL_CONTENT_WIDTH 160.0f

#define CELL_CONTENT_MARGIN 10.0f
#define CELL_CONTENT_MARGIN2 20.0f
...
- (void)viewDidLoad {
    ...
    //count 알려주는 소스 앞으로 쓸 수도 있어 주석처리
//    NSDictionary *dicCount = GLOBAL_VALUES.dicImgCount;
//    int count_promotion = [dicCount intForKey:@"count_promotion"];
//    int count_shoppingmall = [dicCount intForKey:@"count_shoppingmall"];
    ...
    NSString *szBody = [NSString stringWithFormat:@"img_code=%@&mall_type=%d&order_type=%d&start=%d&limit=%d&language_code=%@",
                        GLOBAL_VALUES.ImageSearchResultId,0,3,0,100,
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    /*
    ShopViewController *view = [self.storyboard instantiateViewControllerWithIdentifier:@"ShopViewController"];
